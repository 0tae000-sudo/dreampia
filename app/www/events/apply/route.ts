  ...
  try {
    ...
    const application = await db.eventApplication.create({
      data: {
        ...
        schoolLevel: validated.schoolLevel as "ELEMENTARY" | "MIDDLE" | "HIGH" | "INSTITUTE",
        postcode: validated.postcode,
        address: validated.address,
        detailAddress: validated.detailAddress,
        managerName: validated.managerName,
        managerPosition: validated.managerPosition,
        managerPhone: validated.managerPhone,
        managerEmail: validated.managerEmail,
        adminName: validated.adminName,
        adminPosition: validated.adminPosition,
        adminPhone: validated.adminPhone,
        adminEmail: validated.adminEmail,
        eventName: validated.eventName,
        programType: validated.programType as never,
        eventDate: new Date(validated.eventDate),
        targetGrades: validated.targetGrades as never,
        totalStudents: validated.totalStudents,
        studentChangeType: validated.studentChangeType as "CHANGE_PER_PERIOD" | "NO_CHANGE",
        mentorRequestCount: validated.mentorRequestCount,
        mentorPreference: validated.mentorPreference ?? null,
        providedItems: validated.providedItems as never,
        expectedQuote: validated.expectedQuote ?? null,
